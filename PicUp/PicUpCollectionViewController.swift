//
//  PicUpCollectionViewController.swift
//  PicUp
//
//  Created by Charlie Kim on 2018. 2. 13..
...
class PicUpCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell : PicUpCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! PicUpCollectionViewCell
